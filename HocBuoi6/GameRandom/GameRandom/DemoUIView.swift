...
print(screenWidth, screenHeight)
       ...
       // blueView.layer.cornerRadius = blueView.frame.width/2 //set blueView thành hình tròn
        blueView.transform = CGAffineTransform(rotationAngle: CGFloat.pi/4) //xoay một góc 45 độ, command dòng trên lại vì biến thành hình tròn thì có xoay cũng ko nhìn được
